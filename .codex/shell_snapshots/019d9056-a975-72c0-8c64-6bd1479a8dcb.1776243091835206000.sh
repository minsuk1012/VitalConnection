...
kc () {
	...
	repo_root=$(git rev-parse --show-toplevel 2>/dev/null)  || {
		echo "kc: Git 저장소에서만 사용할 수 있습니다." >&2
		return 1
	}
	CODEX_HOME="${repo_root}/.codex" codex "$@"
}
load-nvmrc () {
...
# aliases 11
alias EDITOR=/Applications/Cursor.app/Contents/MacOS/Cursor
alias c='open -a '\''Visual Studio Code'\'
alias cb='claude --dangerously-skip-permissions'
alias claude-mem='bun "/Users/choiminsuk/.claude/plugins/marketplaces/thedotmack/plugin/scripts/worker-service.cjs"'
alias code='function _code() { if [ $# -eq 0 ]; then open -a "Visual Studio Code" .; else open -a "Visual Studio Code" "$@"; fi }; _code'
alias idea='function _idea() { if [ $# -eq 0 ]; then open -a "IntelliJ IDEA" .; else open -a "IntelliJ IDEA" "$@"; fi }; _idea'
alias run-help=man
alias sublime='function _sublime() { if [ $# -eq 0 ]; then open -a "Sublime Text" .; else open -a "Sublime Text" "$@"; fi }; _sublimeexport'
alias vscode='function _vscode() { if [ $# -eq 0 ]; then open -a "Visual Studio Code" .; else open -a "Visual Studio Code" "$@"; fi }; _vscode'
alias which-command=whence
alias windsurf='function _windsurf() { if [ $# -eq 0 ]; then open -a Windsurf .; else open -a Windsurf "$@"; fi }; _windsurf'

# exports 31
export AGENT_BROWSER_HEADED=true
export ANDROID_HOME=/Users/choiminsuk/Library/Android/sdk
export BUN_INSTALL=/Users/choiminsuk/.bun
export CODEX_HOME=/Users/choiminsuk/Desktop/beautypass_marketing/vitalconnection/.codex
...
export GHOSTTY_SHELL_FEATURES=cursor:steady,path,title
export HOME=/Users/choiminsuk
export JAVA_HOME=/opt/homebrew/opt/openjdk@17
export LANG=en_US.UTF-8
export LOGNAME=choiminsuk
export NVM_BIN=/Users/choiminsuk/.nvm/versions/node/v24.13.1/bin
export NVM_CD_FLAGS=-q
export NVM_DIR=/Users/choiminsuk/.nvm
export NVM_INC=/Users/choiminsuk/.nvm/versions/node/v24.13.1/include/node
export OSLogRateLimit=64
export SHELL=/bin/zsh
export SSH_AUTH_SOCK='/Users/choiminsuk/Library/Group Containers/2BUA8C4S2C.com.1password/t/agent.sock'
export TERM=xterm-ghostty
export TERMINFO=/Applications/Ghostty.app/Contents/Resources/terminfo
export TERM_PROGRAM=ghostty
export TERM_PROGRAM_VERSION=1.3.1
export TMPDIR=/var/folders/5v/rng4b4y977vcdd0zfly5nt000000gn/T/
export USER=choiminsuk
